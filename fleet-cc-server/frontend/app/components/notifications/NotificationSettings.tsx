	...
	const loadPreferences = async () => {
		try {
			...
			const response = await fetch(
				`${apiUrl}/api/notifications/user/me/preferences`,
				{
					headers: {
				...
				<label className={styles.checkboxLabel}>
					...
					<div className={styles.labelContent}>
						...
						<p className={styles.helpText}>
							When enabled, notifications will be automatically
							marked as viewed and won't show popups, but will
							still appear in your notification history.
						</p>
					</div>
				</label>
			</div>
